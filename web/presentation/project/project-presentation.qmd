...
-   Anything in lab – sign out expensive stuff & submit error reports for anything that breaks.
    -   The main E80 main PCBs and protoboards
...
Can fit about 6 wires in a penetrator Drill on flat faces of box: need flat rubber washers on box surface.
...
Connect to motherboard with right angle header. Place below it.
...
-   What are your...
    -   Independent variable(s): e.g., $y(t)$, $z(x,y)$
    -   Dependent variable(s): e.g., $t$, $x$, $y$
