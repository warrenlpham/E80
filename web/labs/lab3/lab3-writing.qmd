...
Prepare a high-quality electrical schematic and mechanical drawing to include in a methods section of a technical memo describing the operation of the transimpedance amplifier and turbidity meter you built in Lab 3.
The accompanying text should describe how the circuit and cuvette holder are used to build the turbidity meter.

The electrical schematic describes the functional connection of the components in an electrical circuit.
...
For this assignment, draw a schematic of the transimpedance amplifier you developed for your turbidity meter.
Ensure your schematic follows all the proper conventions as detailed in the specs below and in the lab manual.
Include a 100-150 word section of text to describe the design and operation of the transimpedance amplifier.
