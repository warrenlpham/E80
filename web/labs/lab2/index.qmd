...
1. Demonstrate how to use electrical test equipment such as a multimeter, function generator, and oscilloscope.
2. Explain why oscilloscope probes have 1X and 10X settings and when each setting should be used.
3. Demonstrate error analysis techniques using resistive voltage dividers and voltage measurements with electrical measurement equipment.
...
There are a variety of references which might make your life easier.  Two documents from previous iterations of E80 [Auntie Spark's Guide to breadboards](http://www.eng.hmc.edu/NewE80/PDFs/AuntieSparksGuideToBreadboarding.pdf) and [Uncle Sparky's guide to Voltage, Current, and Resistance Measurements](http://www.eng.hmc.edu/NewE80/PDFs/Uncle%20Sparky's%20Guide%20to%20Voltage%20Current%20and%20Resistance%20Measurement.pdf) are recommended in particular.
