...
3. Adjust the fan speed with the knob on the RPM Controller while reading the RPM from the Fan Speed Display.  Adjust the fan speed from 15% to 55% of max fan speed (in increments of 10%). At each fan speed:   
