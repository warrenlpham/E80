...
- [ ] Predicted and measured Voltage at zero depth is close to 0.3 V.
- [ ] Predicted Voltage at 1m depth is close to 3.0V
...
- [ ] Provides a picture of the thermistor interface circuit, including the pressure sensor
- [ ] Provides a schematic of the thermistor interface circuit, including the pressure sensor
- [ ] Equation relating op-amp input Voltage to op-amp output Voltage is included.  May be incorrect if it looks like a good faith effort.
...
- [ ] Predicted Voltages and measured voltages match to within uncertainty and are consistent with equations.
- [ ] Predicted and measured Voltage at 0 °C is close to 0.3 V.
- [ ] Predicted and measured Voltage at 20 °C is close to 3.0 V.
