...
Welcome to the E72+E80 MATLAB Tutorial! If you need more support, ask someone during office hours. Also, there are lots of resources online for using MATLAB.
...
2.  A brief, 4-5 sentence reflection detailing something you learned from the [plotting question](#matlab-plotting-video).
...
### 4. MATLAB Debugging Tips (optional, but strongly recommended)
...
Practice your MATLAB debugging skills on this script [debugme.m](https://github.com/HMC-E80/E80/tree/main/MATLAB/debugme.m), which is supposed to create a matrix like the one below. The code has several errors in it that you'll need to fix. You do not need to turn in your final code for this class. The goal of this in-class assignment is to help prepare you for the work that you'll be doing in E72.
