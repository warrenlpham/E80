...
It is also possible to use an online copy of MATLAB [here](https://matlab.mathworks.com).

## MATLAB On-ramp

If you have extra time during Lab 0 you may work on the MATLAB on-ramp tutorial.

You can find the assignment [here](./matlab-startup.qmd).
