...
2. [Hooking up an external LED](https://www.pjrc.com/teensy/tutorial2.html) 
    ...
    This tutorial also uses Teensy 2.0.  Refer to 4.0 pinout diagram to make appropriate changes your circuit. Note that you should just use a single red LED instead of an RGB LED.  An instructor can help you figure out which pin is the ground pin.
