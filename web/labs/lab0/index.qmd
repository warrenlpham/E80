...
- [ ] choose/make 3 waterproof motors, test, and attach to frame
- [ ] charge your battery
- [ ] check out and solder header pins to Teensy 4.0 **(Limited supply - Do not lose/break/eat)**
...
Although less critical for this introduction lab, **it will be imperative to get into the habit of distributing work across team members.** Identify dependencies and **work in parallel.**
...
In order to fit the waterproof box that will house the motherboard, microcontroller, battery, additional sensors, etc., you will need to increase the width of the frame.
