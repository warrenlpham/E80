...
- [ ] Take the mean of data to calculate the resting zero acceleration values. Report them clearly.
- [ ] Includes description of how to calculate descriptive statistics and correct values.
