...
## Github
- This is where you will find updated E80 code throughout the semester. Git is a distributed version control system where you can download a local clone of a collection of source code files and track changes to the code.
...
Team assignments can be found [here](https://docs.google.com/spreadsheets/d/1ybzgz6GolW6FgcQ1pTlchQTeFiXQY2csQyqV71vN7dU/edit?pli=1#gid=0).
...
| [Laboratory Submission Sheets](#laboratory-submission-sheets)   |   28%  |
...
- There are a total of 8 labs in the class: Lab0 through Lab7. For each of the labs , you must submit a submission sheet that contains the data you collected during the lab. This submission sheet will be evaluated for correctness: it's a way of assessing whether your experimental procedure was correct during the lab. Each submission sheet you provide will be worth 3.5% of your final grade, and you submit 8 submission sheets for a total of 28%.

- These are group assignments and they are submitted on Canvas.

#### Laboratory Writing Assignments

- In Weeks 2 through 6, you will be required to complete a writing assignment that is about 1 page in length. Prompts for the writing assignment are included on each lab page. The purpose of the writing assignments is to train you in specific aspects of scientific writing: making figures, using tables, equations, etc. You must complete a rough draft of each week's writing assignment, then you will review your peer's drafts and edit your own during the writing and reflection section. The final draft must be submitted by the end of the writing and reflection section. Each writing assignment will be worth 3.5% of your final grade and you submit five assignments for a total of 17.5%. There is an optional 6th writing assigment in week 7 that is worth 0.5% of your final grade.
